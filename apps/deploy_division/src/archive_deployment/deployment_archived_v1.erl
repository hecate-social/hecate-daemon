...
to_map(#deployment_archived_v1{division_id = V, archived_at = AA, archived_by = AB, reason = R}) ->
    #{
...
get_division_id(#deployment_archived_v1{division_id = V}) -> V.
get_archived_at(#deployment_archived_v1{archived_at = V}) -> V.
get_archived_by(#deployment_archived_v1{archived_by = V}) -> V.
get_reason(#deployment_archived_v1{reason = V}) -> V.
