...
to_map(#deployment_resumed_v1{division_id = V, resumed_at = RA}) ->
    #{
...
from_map(Map) ->
    ...
    {ok, #deployment_resumed_v1{division_id = DivisionId, resumed_at = ResumedAt}}.

get_division_id(#deployment_resumed_v1{division_id = V}) -> V.
get_resumed_at(#deployment_resumed_v1{resumed_at = V}) -> V.
