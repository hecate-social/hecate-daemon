%%% @doc API handler: GET /api/cartwheels/:cartwheel_id/testing/builds
%%%
%%% List build verifications for a cartwheel.
%%% @end
-module(get_build_verifications_page_api).
...
handle_get(Req0, _State) ->
    ...
    case get_build_verifications_page:execute(Filters) of
        {ok, Builds} ->
            hecate_api_utils:json_ok(#{builds => Builds}, Req0);
        {error, Reason} ->
