%%% @doc API handler: GET /api/cartwheels/:cartwheel_id/discovery/terms
%%%
%%% List ubiquitous language terms for a cartwheel.
%%% @end
-module(get_terms_page_api).
...
handle_get(Req0, _State) ->
    ...
    case get_terms_page:execute(Filters#{cartwheel_id => CartwheelId}) of
        {ok, Terms} ->
            hecate_api_utils:json_ok(#{terms => Terms}, Req0);
        {error, Reason} ->
