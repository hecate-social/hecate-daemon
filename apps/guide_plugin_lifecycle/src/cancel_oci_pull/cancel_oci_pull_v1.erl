%%% @doc cancel_oci_pull_v1 command
...
-export_type([cancel_oci_pull_v1/0]).
-opaque cancel_oci_pull_v1() :: #cancel_oci_pull_v1{}.
...
from_map(Map) ->
    ...
    case PluginId of
        ...
        _ -> {ok, #cancel_oci_pull_v1{plugin_id = PluginId}}
    end.

-spec get_plugin_id(cancel_oci_pull_v1()) -> binary().
get_plugin_id(#cancel_oci_pull_v1{plugin_id = V}) -> V.
