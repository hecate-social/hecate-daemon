%%% @doc confirm_plugin_loaded_v1 command
%%% Confirms that a plugin has been successfully loaded.
...
-export_type([confirm_plugin_loaded_v1/0]).
-opaque confirm_plugin_loaded_v1() :: #confirm_plugin_loaded_v1{}.
...
from_map(Map) ->
    ...
    case PluginId of
        ...
        _ -> {ok, #confirm_plugin_loaded_v1{plugin_id = PluginId}}
    end.

-spec get_plugin_id(confirm_plugin_loaded_v1()) -> binary().
get_plugin_id(#confirm_plugin_loaded_v1{plugin_id = V}) -> V.
