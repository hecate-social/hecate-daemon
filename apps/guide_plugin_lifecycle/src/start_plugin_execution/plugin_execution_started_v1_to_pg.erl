%%% @doc Emitter: plugin_execution_started_v1 -> pg (internal pub/sub)
-module(plugin_execution_started_v1_to_pg).
-behaviour(gen_server).
-export([start_link/0]).
-export([init/1, handle_call/3, handle_cast/2, handle_info/2, terminate/2]).

-define(EVENT_TYPE, <<"plugin_execution_started_v1">>).
-define(PG_GROUP, {plugin_execution_started_v1, node}).
-define(SUB_NAME, <<"plugin_execution_started_v1_to_pg">>).
