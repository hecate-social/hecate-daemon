%%% @doc SQLite connection pool for query_alc read models.
-module(query_alc_store).
...
-define(DB_PATH, "data/query_alc.db").
...
create_tables(Db) ->
    Stmts = [
        ...
        "CREATE INDEX IF NOT EXISTS idx_dossier_designs_project ON dossier_designs(project_id);",
        ...
        "CREATE INDEX IF NOT EXISTS idx_spoke_inventory_project ON spoke_inventory(project_id);",
        ...
        "CREATE INDEX IF NOT EXISTS idx_spoke_implementations_project ON spoke_implementations(project_id);",
        ...
        "CREATE INDEX IF NOT EXISTS idx_build_verifications_project ON build_verifications(project_id);",
