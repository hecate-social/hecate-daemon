...
-spec get_display_name(initiate_license_v1()) -> binary() | undefined.
get_display_name(#initiate_license_v1{display_name = V}) -> V.
...
-spec get_group_icon(initiate_license_v1()) -> binary() | undefined.
get_group_icon(#initiate_license_v1{group_icon = V}) -> V.
