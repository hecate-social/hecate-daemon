...
create_event(Cmd) ->
    license_initiated_v1:new(#{
        ...
        display_name       => initiate_license_v1:get_display_name(Cmd),
        ...
        group_icon         => initiate_license_v1:get_group_icon(Cmd),
        github_repo        => initiate_license_v1:get_github_repo(Cmd),
        oci_image          => initiate_license_v1:get_oci_image(Cmd),
        plugin_type        => initiate_license_v1:get_plugin_type(Cmd),
        callback_module    => initiate_license_v1:get_callback_module(Cmd),
        package_url        => initiate_license_v1:get_package_url(Cmd),
