%%% @doc Mesh projection: capability_retracted_v1 → Macula Mesh
%%% Projects capability retractions to the mesh as integration facts.
-module(capability_retracted_v1_to_mesh).
