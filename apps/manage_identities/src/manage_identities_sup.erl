...
-define(STORE_ID, manage_identities_store).
-define(DATA_DIR, "data/reckon/identities").
...
init([]) ->
    ...
    Children = [
        ...
        {identity_registered_v1_to_mesh,
            {identity_registered_v1_to_mesh, start_link, []},
            permanent, 5000, worker, [identity_registered_v1_to_mesh]},
        {identity_updated_v1_to_mesh,
            {identity_updated_v1_to_mesh, start_link, []},
            permanent, 5000, worker, [identity_updated_v1_to_mesh]}
    ],
