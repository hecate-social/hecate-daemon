...
to_map(#rescue_resumed_v1{division_id = V, resumed_at = RA}) ->
    #{
...
from_map(Map) ->
    ...
    {ok, #rescue_resumed_v1{division_id = DivisionId, resumed_at = ResumedAt}}.

get_division_id(#rescue_resumed_v1{division_id = V}) -> V.
get_resumed_at(#rescue_resumed_v1{resumed_at = V}) -> V.
