%%% @doc TUI emitter: venture_setup_v1 -> TUI SSE connections
%%%
%%% Listens to the venture_setup_v1 pg group and broadcasts
%%% JSON-encoded facts to all connected TUI clients.
%%% @end
-module(venture_setup_v1_to_tui).
...
-define(SCOPE, pg).
-define(EVENT_GROUP, venture_setup_v1).
...
init([]) ->
    ...
    logger:info("[venture_setup_v1_to_tui] Emitter started, joined ~p group", [?EVENT_GROUP]),
    {ok, #{}}.
