%%% @doc offering_initiated_v1 event
%%% Emitted when an author initiates a new offering.
-module(offering_initiated_v1).
...
-export_type([offering_initiated_v1/0]).
-opaque offering_initiated_v1() :: #offering_initiated_v1{}.
...
-spec to_map(offering_initiated_v1()) -> map().
to_map(#offering_initiated_v1{} = E) ->
    #{
        event_type => <<"offering_initiated_v1">>,
        offering_id => E#offering_initiated_v1.offering_id,
        plugin_id => E#offering_initiated_v1.plugin_id,
        author_id => E#offering_initiated_v1.author_id,
        plugin_name => E#offering_initiated_v1.plugin_name,
        display_name => E#offering_initiated_v1.display_name,
        description => E#offering_initiated_v1.description,
        icon => E#offering_initiated_v1.icon,
        group_name => E#offering_initiated_v1.group_name,
        group_icon => E#offering_initiated_v1.group_icon,
        github_repo => E#offering_initiated_v1.github_repo,
        ...
        min_daemon_version => E#offering_initiated_v1.min_daemon_version,
        publisher_identity => E#offering_initiated_v1.publisher_identity,
        selling_formula => E#offering_initiated_v1.selling_formula,
        license_type => E#offering_initiated_v1.license_type,
        fee_cents => E#offering_initiated_v1.fee_cents,
        fee_currency => E#offering_initiated_v1.fee_currency,
        duration_days => E#offering_initiated_v1.duration_days,
        node_limit => E#offering_initiated_v1.node_limit,
        manifest_url => E#offering_initiated_v1.manifest_url,
        manifest_checksum => E#offering_initiated_v1.manifest_checksum,
        author_signature => E#offering_initiated_v1.author_signature,
        oci_image_verified => E#offering_initiated_v1.oci_image_verified,
        oci_image_digest => E#offering_initiated_v1.oci_image_digest,
        initiated_at => E#offering_initiated_v1.initiated_at
    }.

-spec from_map(map()) -> {ok, offering_initiated_v1()} | {error, term()}.
from_map(Map) ->
...
%% Accessors
-spec get_offering_id(offering_initiated_v1()) -> binary().
get_offering_id(#offering_initiated_v1{offering_id = V}) -> V.

-spec get_plugin_id(offering_initiated_v1()) -> binary().
get_plugin_id(#offering_initiated_v1{plugin_id = V}) -> V.

-spec get_author_id(offering_initiated_v1()) -> binary().
get_author_id(#offering_initiated_v1{author_id = V}) -> V.

-spec get_plugin_name(offering_initiated_v1()) -> binary() | undefined.
get_plugin_name(#offering_initiated_v1{plugin_name = V}) -> V.

-spec get_display_name(offering_initiated_v1()) -> binary() | undefined.
get_display_name(#offering_initiated_v1{display_name = V}) -> V.

-spec get_description(offering_initiated_v1()) -> binary() | undefined.
get_description(#offering_initiated_v1{description = V}) -> V.

-spec get_icon(offering_initiated_v1()) -> binary() | undefined.
get_icon(#offering_initiated_v1{icon = V}) -> V.

-spec get_group_name(offering_initiated_v1()) -> binary() | undefined.
get_group_name(#offering_initiated_v1{group_name = V}) -> V.

-spec get_group_icon(offering_initiated_v1()) -> binary() | undefined.
get_group_icon(#offering_initiated_v1{group_icon = V}) -> V.

-spec get_github_repo(offering_initiated_v1()) -> binary() | undefined.
get_github_repo(#offering_initiated_v1{github_repo = V}) -> V.

-spec get_homepage(offering_initiated_v1()) -> binary() | undefined.
get_homepage(#offering_initiated_v1{homepage = V}) -> V.

-spec get_tags(offering_initiated_v1()) -> binary() | undefined.
get_tags(#offering_initiated_v1{tags = V}) -> V.
...
-spec get_version(offering_initiated_v1()) -> binary() | undefined.
get_version(#offering_initiated_v1{version = V}) -> V.

-spec get_manifest_tag(offering_initiated_v1()) -> binary() | undefined.
get_manifest_tag(#offering_initiated_v1{manifest_tag = V}) -> V.

-spec get_min_daemon_version(offering_initiated_v1()) -> binary() | undefined.
get_min_daemon_version(#offering_initiated_v1{min_daemon_version = V}) -> V.

-spec get_publisher_identity(offering_initiated_v1()) -> binary() | undefined.
get_publisher_identity(#offering_initiated_v1{publisher_identity = V}) -> V.

-spec get_selling_formula(offering_initiated_v1()) -> binary() | undefined.
get_selling_formula(#offering_initiated_v1{selling_formula = V}) -> V.

-spec get_license_type(offering_initiated_v1()) -> binary() | undefined.
get_license_type(#offering_initiated_v1{license_type = V}) -> V.

-spec get_fee_cents(offering_initiated_v1()) -> non_neg_integer() | undefined.
get_fee_cents(#offering_initiated_v1{fee_cents = V}) -> V.

-spec get_fee_currency(offering_initiated_v1()) -> binary() | undefined.
get_fee_currency(#offering_initiated_v1{fee_currency = V}) -> V.

-spec get_duration_days(offering_initiated_v1()) -> non_neg_integer() | undefined.
get_duration_days(#offering_initiated_v1{duration_days = V}) -> V.

-spec get_node_limit(offering_initiated_v1()) -> non_neg_integer() | undefined.
get_node_limit(#offering_initiated_v1{node_limit = V}) -> V.

-spec get_manifest_url(offering_initiated_v1()) -> binary() | undefined.
get_manifest_url(#offering_initiated_v1{manifest_url = V}) -> V.

-spec get_manifest_checksum(offering_initiated_v1()) -> binary() | undefined.
get_manifest_checksum(#offering_initiated_v1{manifest_checksum = V}) -> V.

-spec get_author_signature(offering_initiated_v1()) -> binary() | undefined.
get_author_signature(#offering_initiated_v1{author_signature = V}) -> V.

-spec get_oci_image_verified(offering_initiated_v1()) -> 0 | 1 | undefined.
get_oci_image_verified(#offering_initiated_v1{oci_image_verified = V}) -> V.

-spec get_oci_image_digest(offering_initiated_v1()) -> binary() | undefined.
get_oci_image_digest(#offering_initiated_v1{oci_image_digest = V}) -> V.

-spec get_initiated_at(offering_initiated_v1()) -> integer().
get_initiated_at(#offering_initiated_v1{initiated_at = V}) -> V.
