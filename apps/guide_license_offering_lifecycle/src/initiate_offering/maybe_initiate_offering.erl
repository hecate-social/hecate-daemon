...
create_event(Cmd) ->
    offering_initiated_v1:new(#{
        ...
        display_name => initiate_offering_v1:get_display_name(Cmd),
        ...
        group_icon => initiate_offering_v1:get_group_icon(Cmd),
        ...
        package_url => initiate_offering_v1:get_package_url(Cmd),
        plugin_type => initiate_offering_v1:get_plugin_type(Cmd),
        callback_module => initiate_offering_v1:get_callback_module(Cmd),
