...
-export([get_project_id/1, get_incident_id/1, get_resolution/1, get_resolved_at/1]).
...
to_map(#incident_resolved_v1{} = E) ->
    #{
        ...
        project_id => E#incident_resolved_v1.project_id,
...
%% Accessors
get_project_id(#incident_resolved_v1{project_id = V}) -> V.
