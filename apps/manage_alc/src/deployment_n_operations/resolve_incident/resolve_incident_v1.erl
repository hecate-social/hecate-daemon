...
-export([get_project_id/1, get_incident_id/1, get_resolution/1]).
...
new(#{project_id := ProjectId, incident_id := IncidentId, resolution := Resolution} = _Params) ->
...
validate(#resolve_incident_v1{project_id = P}) when
...
to_map(#resolve_incident_v1{} = Cmd) ->
    #{
        ...
        project_id => Cmd#resolve_incident_v1.project_id,
...
%% Accessors
get_project_id(#resolve_incident_v1{project_id = V}) -> V.
