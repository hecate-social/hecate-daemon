...
handle(Cmd) ->
    ProjectId = record_deployment_v1:get_project_id(Cmd),
    Environment = record_deployment_v1:get_environment(Cmd),
    Version = record_deployment_v1:get_version(Cmd),
    case validate_command(ProjectId, Environment, Version) of
        ok ->
...
validate_command(ProjectId, Environment, Version) when
...
create_event(Cmd) ->
    deployment_recorded_v1:new(#{
        project_id => record_deployment_v1:get_project_id(Cmd),
