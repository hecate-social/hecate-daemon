%%% @doc manage_alc top-level supervisor
%%%
%%% Starts this domain's ReckonDB store.
%%% No emitters — ALC is internal lifecycle tracking.
-module(manage_alc_sup).
...
-define(STORE_ID, manage_alc_store).
-define(DATA_DIR, "data/reckon/manage_alc").
