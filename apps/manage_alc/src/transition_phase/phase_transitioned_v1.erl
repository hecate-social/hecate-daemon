...
-export([get_project_id/1, get_from_phase/1, get_to_phase/1, get_transitioned_at/1]).
...
to_map(#phase_transitioned_v1{} = E) ->
    #{
        ...
        project_id => E#phase_transitioned_v1.project_id,
...
from_map(#{project_id := ProjectId, from_phase := FromPhase, to_phase := ToPhase} = Map) ->
...
%% Accessors
get_project_id(#phase_transitioned_v1{project_id = V}) -> V.
