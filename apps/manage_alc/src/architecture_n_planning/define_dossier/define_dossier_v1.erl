...
-export([get_project_id/1, get_dossier_id/1, get_dossier_name/1,
...
new(#{project_id := ProjectId, dossier_name := DossierName} = Params) ->
...
validate(#define_dossier_v1{project_id = P}) when
...
to_map(#define_dossier_v1{} = Cmd) ->
    #{
        ...
        project_id => Cmd#define_dossier_v1.project_id,
...
%% Accessors
get_project_id(#define_dossier_v1{project_id = V}) -> V.
