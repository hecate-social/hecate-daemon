...
new(#{project_id := ProjectId, dossier_id := DossierId,
...
to_map(#dossier_defined_v1{} = E) ->
    #{
        ...
        project_id => E#dossier_defined_v1.project_id,
...
from_map(#{project_id := ProjectId, dossier_id := DossierId,
...
%% Accessors
get_project_id(#dossier_defined_v1{project_id = V}) -> V.
