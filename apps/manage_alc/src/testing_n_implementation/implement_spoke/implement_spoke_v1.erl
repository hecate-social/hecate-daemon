...
new(#{project_id := ProjectId, spoke_id := SpokeId} = Params) ->
...
validate(#implement_spoke_v1{project_id = P}) when
...
to_map(#implement_spoke_v1{} = Cmd) ->
    #{
        ...
        project_id => Cmd#implement_spoke_v1.project_id,
...
%% Accessors
get_project_id(#implement_spoke_v1{project_id = V}) -> V.
