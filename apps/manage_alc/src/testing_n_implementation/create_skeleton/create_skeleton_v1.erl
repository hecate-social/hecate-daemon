...
-export([get_project_id/1, get_skeleton_id/1, get_description/1]).
...
validate(#create_skeleton_v1{project_id = P}) when
...
to_map(#create_skeleton_v1{} = Cmd) ->
    #{
        ...
        project_id => Cmd#create_skeleton_v1.project_id,
...
%% Accessors
get_project_id(#create_skeleton_v1{project_id = V}) -> V.
