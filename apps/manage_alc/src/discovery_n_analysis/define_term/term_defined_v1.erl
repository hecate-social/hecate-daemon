...
-export([get_project_id/1, get_term_id/1, get_term/1,
...
new(#{project_id := ProjectId, term_id := TermId,
...
to_map(#term_defined_v1{} = E) ->
    #{
        ...
        project_id => E#term_defined_v1.project_id,
...
from_map(#{project_id := ProjectId, term_id := TermId,
...
%% Accessors
get_project_id(#term_defined_v1{project_id = V}) -> V.
