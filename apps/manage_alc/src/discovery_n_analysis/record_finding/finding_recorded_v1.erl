...
-export([get_project_id/1, get_finding_id/1, get_category/1,
...
new(#{project_id := ProjectId, finding_id := FindingId, category := Category,
      title := Title} = Params) ->
    #finding_recorded_v1{
...
to_map(#finding_recorded_v1{} = E) ->
    #{
        ...
        project_id => E#finding_recorded_v1.project_id,
...
from_map(#{project_id := ProjectId, finding_id := FindingId,
...
%% Accessors
get_project_id(#finding_recorded_v1{project_id = V}) -> V.
