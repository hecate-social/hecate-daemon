-module(resolve_learning_dispute_api).
-export([init/2, routes/0]).

routes() -> [{"/api/mentors/learnings/:learning_id/resolve", ?MODULE, []}].
...
handle_post(Req0, _State) ->
    ...
    case hecate_api_utils:read_json_body(Req0) of
        {ok, Params, Req1} ->
            ...
            dispatch_cmd(resolve_learning_dispute_v1, maybe_resolve_learning_dispute, CmdParams, Req1);
