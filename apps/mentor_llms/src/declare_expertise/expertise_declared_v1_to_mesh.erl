%%% @doc Mesh emitter: expertise_declared_v1 -> hecate.mentor.available
%%% Publishes expertise declarations to mesh as integration facts.
-module(expertise_declared_v1_to_mesh).
