...
to_map(#testing_archived_v1{division_id = V, archived_at = AA, archived_by = AB, reason = R}) ->
    #{
...
get_division_id(#testing_archived_v1{division_id = V}) -> V.
get_archived_at(#testing_archived_v1{archived_at = V}) -> V.
get_archived_by(#testing_archived_v1{archived_by = V}) -> V.
get_reason(#testing_archived_v1{reason = V}) -> V.
