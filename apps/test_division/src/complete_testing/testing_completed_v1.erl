...
to_map(#testing_completed_v1{division_id = V, completed_at = CA}) ->
    #{
...
from_map(Map) ->
    ...
    {ok, #testing_completed_v1{division_id = DivisionId, completed_at = CompletedAt}}.

get_division_id(#testing_completed_v1{division_id = V}) -> V.
