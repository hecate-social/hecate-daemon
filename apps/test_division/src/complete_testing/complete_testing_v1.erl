...
validate(#complete_testing_v1{division_id = V}) when not is_binary(V); V =:= <<>> ->
    {error, {invalid_field, division_id}};
validate(_) -> ok.

to_map(#complete_testing_v1{division_id = V}) ->
    #{
...
get_division_id(#complete_testing_v1{division_id = V}) -> V.
