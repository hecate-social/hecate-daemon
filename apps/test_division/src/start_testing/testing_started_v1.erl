...
to_map(#testing_started_v1{division_id = V, started_at = SA, started_by = SB}) ->
    #{
...
from_map(Map) ->
    ...
    {ok, #testing_started_v1{division_id = DivisionId, started_at = StartedAt, started_by = StartedBy}}.

get_division_id(#testing_started_v1{division_id = V}) -> V.
get_started_at(#testing_started_v1{started_at = V}) -> V.
get_started_by(#testing_started_v1{started_by = V}) -> V.
