%%% @doc Projection: launcher_initialized_v1 -> launcher ETS read model.
%%% Clears and rebuilds both entries and groups from the init payload.
-module(launcher_initialized_v1_to_launcher).
-behaviour(evoq_projection).
-export([interested_in/0, init/1, project/4]).

interested_in() -> [<<"launcher_initialized_v1">>].
