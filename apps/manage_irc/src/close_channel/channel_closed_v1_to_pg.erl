%%% @doc Emitter: channel_closed_v1 -> pg (internal pub/sub)
-module(channel_closed_v1_to_pg).
-behaviour(gen_server).
-export([start_link/0]).
-export([init/1, handle_call/3, handle_cast/2, handle_info/2, terminate/2]).

-define(EVENT_TYPE, <<"channel_closed_v1">>).
-define(PG_GROUP, channel_closed_v1).
-define(SUB_NAME, <<"channel_closed_v1_to_pg">>).
