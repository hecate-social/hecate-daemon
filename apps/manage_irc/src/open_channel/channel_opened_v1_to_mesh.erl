%%% @doc Mesh emitter: channel_opened_v1 -> Macula Mesh
%%% Publishes channel opening announcements to mesh for cross-node discovery.
-module(channel_opened_v1_to_mesh).
...
handle_info({event, #evoq_event{data = EventData}}, State) ->
    hecate_mesh_client:publish(<<"hecate.irc.channel.opened">>, EventData),
    {noreply, State};
