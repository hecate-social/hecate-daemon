%%% @doc API handler: GET /api/divisions/:division_id/fixes
-module(get_fixes_page_api).
-export([init/2]).
...
handle_get(Req0, _State) ->
    ...
    case get_fixes_page:get(Filters) of
        {ok, Fixes} ->
            hecate_api_utils:json_ok(#{fixes => Fixes}, Req0);
        {error, Reason} ->
