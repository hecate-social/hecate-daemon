...
to_map(#plan_paused_v1{division_id = V, paused_at = PA, reason = R}) ->
    #{
...
from_map(Map) ->
    ...
    {ok, #plan_paused_v1{division_id = DivisionId, paused_at = PausedAt, reason = Reason}}.

get_division_id(#plan_paused_v1{division_id = V}) -> V.
get_paused_at(#plan_paused_v1{paused_at = V}) -> V.
get_reason(#plan_paused_v1{reason = V}) -> V.
