...
to_map(#plan_completed_v1{division_id = V, completed_at = CA}) ->
    #{
...
from_map(Map) ->
    ...
    {ok, #plan_completed_v1{division_id = DivisionId, completed_at = CompletedAt}}.

get_division_id(#plan_completed_v1{division_id = V}) -> V.
get_completed_at(#plan_completed_v1{completed_at = V}) -> V.
