%%% @doc Listener for plugin_execution_started_v1 events.
%%% Subscribes to evoq, projects to SQLite plugins table.
-module(on_plugin_execution_started_v1_to_sqlite_plugins).
...
-define(SUB_NAME, <<"plugin_execution_started_v1_to_sqlite_plugins">>).
...
handle_info({events, Events}, State) ->
    lists:foreach(fun(#evoq_event{data = Data}) ->
        case plugin_execution_started_v1_to_sqlite_plugins:project(Data) of
            ok -> ok;
            {error, Reason} ->
