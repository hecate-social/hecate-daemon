%%% @doc Projection: container_confirmed_down_v1 -> plugins ETS read model.
%%% Sets CONFIRMED_DOWN(32), clears CONFIRMED_UP(16).
-module(container_confirmed_down_v1_to_plugins).
-behaviour(evoq_projection).
-export([interested_in/0, init/1, project/4]).

-define(TABLE, plugins).

interested_in() -> [<<"container_confirmed_down_v1">>].
