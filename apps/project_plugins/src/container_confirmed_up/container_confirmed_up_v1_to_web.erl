%%% @doc Emitter: container_confirmed_up_v1 -> web frontend via SSE.
%%%
%%% Subscribes to container_confirmed_up_v1 and broadcasts the current plugin
%%% state to connected web clients via hecate_web_events.
%%% @end
-module(container_confirmed_up_v1_to_web).
