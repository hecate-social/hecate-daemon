%%% @doc Emitter: oci_pull_started_v1 -> web frontend via SSE.
%%%
%%% Subscribes to oci_pull_started_v1 and broadcasts the current plugin
%%% state to connected web clients via hecate_web_events.
%%% @end
-module(oci_pull_started_v1_to_web).
