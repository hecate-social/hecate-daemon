%%% @doc Emitter: plugin_load_confirmed_v1 -> web frontend via SSE.
%%%
%%% Subscribes to plugin_load_confirmed_v1 and broadcasts the current plugin
%%% state to connected web clients via hecate_web_events.
%%% @end
-module(plugin_load_confirmed_v1_to_web).
