%%% @doc Listener: subscribes to event store for module_generated_v1 events.
-module(on_module_generated_v1_from_pg_project_to_sqlite_generated_modules).
-behaviour(gen_server).
-export([start_link/0]).
-export([init/1, handle_call/3, handle_cast/2, handle_info/2, terminate/2]).

-define(EVENT_TYPE, <<"module_generated_v1">>).
-define(SUB_NAME, <<"module_generated_v1_to_sqlite_generated_modules">>).
