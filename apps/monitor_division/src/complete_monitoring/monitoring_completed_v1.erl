...
to_map(#monitoring_completed_v1{division_id = V, completed_at = CA}) ->
    #{
...
from_map(Map) ->
    ...
    {ok, #monitoring_completed_v1{division_id = DivisionId, completed_at = CompletedAt}}.

get_division_id(#monitoring_completed_v1{division_id = V}) -> V.
get_completed_at(#monitoring_completed_v1{completed_at = V}) -> V.
