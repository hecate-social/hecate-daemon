...
from_map(Map) ->
    ...
    {ok, #monitoring_started_v1{division_id = DivisionId, started_at = StartedAt, started_by = StartedBy}}.

get_division_id(#monitoring_started_v1{division_id = V}) -> V.
get_started_at(#monitoring_started_v1{started_at = V}) -> V.
get_started_by(#monitoring_started_v1{started_by = V}) -> V.
