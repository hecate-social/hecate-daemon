...
to_map(#monitoring_archived_v1{division_id = V, archived_at = AA, archived_by = AB, reason = R}) ->
    #{
...
get_division_id(#monitoring_archived_v1{division_id = V}) -> V.
get_archived_at(#monitoring_archived_v1{archived_at = V}) -> V.
get_archived_by(#monitoring_archived_v1{archived_by = V}) -> V.
get_reason(#monitoring_archived_v1{reason = V}) -> V.
