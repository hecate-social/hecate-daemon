...
from_map(Map) ->
    ...
    {ok, #generation_started_v1{division_id = DivisionId, started_at = StartedAt, started_by = StartedBy}}.

get_division_id(#generation_started_v1{division_id = V}) -> V.
get_started_at(#generation_started_v1{started_at = V}) -> V.
get_started_by(#generation_started_v1{started_by = V}) -> V.
