...
to_map(#generation_paused_v1{division_id = V, paused_at = PA, reason = R}) ->
    #{
...
from_map(Map) ->
    ...
    {ok, #generation_paused_v1{division_id = DivisionId, paused_at = PausedAt, reason = Reason}}.

get_division_id(#generation_paused_v1{division_id = V}) -> V.
get_paused_at(#generation_paused_v1{paused_at = V}) -> V.
get_reason(#generation_paused_v1{reason = V}) -> V.
