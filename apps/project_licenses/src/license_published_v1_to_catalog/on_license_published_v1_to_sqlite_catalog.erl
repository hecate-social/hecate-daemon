%%% @doc Listener: subscribes to license_published_v1 via evoq,
%%% calls projection to update catalog.
-module(on_license_published_v1_to_sqlite_catalog).
...
-define(SUB_NAME, <<"license_published_v1_to_catalog">>).
...
handle_info({events, Events}, State) ->
    lists:foreach(fun(#evoq_event{data = Data}) ->
        license_published_v1_to_sqlite_catalog:project(Data)
    end, Events),
    {noreply, State};
