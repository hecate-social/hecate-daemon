...
%%% Subscribes to phase_resumed_v1 events via evoq and publishes
...
-define(EVENT_TYPE, <<"phase_resumed_v1">>).
-define(PG_GROUP, phase_resumed_v1).
-define(SUB_NAME, <<"phase_resumed_v1_to_pg">>).
