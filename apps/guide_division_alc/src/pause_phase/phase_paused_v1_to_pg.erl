...
%%% Subscribes to phase_paused_v1 events via evoq and publishes
...
-define(EVENT_TYPE, <<"phase_paused_v1">>).
-define(PG_GROUP, phase_paused_v1).
-define(SUB_NAME, <<"phase_paused_v1_to_pg">>).
