%%% @doc Emitter: test_generated_v1 -> pg (internal pub/sub)
%%% Subscribes to test_generated_v1 events via evoq and publishes
...
-define(PG_GROUP, test_generated_v1).
-define(SUB_NAME, <<"test_generated_v1_to_pg">>).
