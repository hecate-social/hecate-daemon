%%% @doc API handler: POST /api/cartwheels/:cartwheel_id/architecture/start
%%%
%%% Starts the architecture phase for a cartwheel.
%%% @end
-module(start_architecture_api).
...
handle_post(Req0, _State) ->
    ...
    dispatch(start_architecture_v1, maybe_start_architecture, CmdParams, Req0).
