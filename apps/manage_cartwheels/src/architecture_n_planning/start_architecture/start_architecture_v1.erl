...
validate(#start_architecture_v1{cartwheel_id = P}) when
...
to_map(#start_architecture_v1{} = Cmd) ->
    #{
        ...
        cartwheel_id => Cmd#start_architecture_v1.cartwheel_id
    }.
...
%% Accessors
get_cartwheel_id(#start_architecture_v1{cartwheel_id = V}) -> V.
