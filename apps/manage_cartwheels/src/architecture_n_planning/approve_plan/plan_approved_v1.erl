...
-export([get_cartwheel_id/1, get_plan_id/1, get_approved_at/1]).
...
to_map(#plan_approved_v1{} = E) ->
    #{
        ...
        cartwheel_id => E#plan_approved_v1.cartwheel_id,
...
from_map(#{cartwheel_id := CartwheelId, plan_id := PlanId} = Map) ->
    {ok, #plan_approved_v1{
        cartwheel_id = CartwheelId,
        plan_id = PlanId,
...
%% Accessors
get_cartwheel_id(#plan_approved_v1{cartwheel_id = V}) -> V.
