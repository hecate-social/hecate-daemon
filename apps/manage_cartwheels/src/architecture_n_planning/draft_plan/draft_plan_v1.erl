...
-export([get_cartwheel_id/1, get_plan_id/1, get_title/1, get_content_ref/1]).
...
validate(#draft_plan_v1{cartwheel_id = P}) when
...
to_map(#draft_plan_v1{} = Cmd) ->
    #{
        ...
        cartwheel_id => Cmd#draft_plan_v1.cartwheel_id,
...
%% Accessors
get_cartwheel_id(#draft_plan_v1{cartwheel_id = V}) -> V.
