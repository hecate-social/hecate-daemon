...
-export([get_cartwheel_id/1, get_spoke_id/1, get_spoke_name/1, get_spoke_type/1,
...
new(#{cartwheel_id := CartwheelId, spoke_id := SpokeId, spoke_name := SpokeName,
...
to_map(#spoke_inventoried_v1{} = E) ->
    #{
        ...
        cartwheel_id => E#spoke_inventoried_v1.cartwheel_id,
...
from_map(#{cartwheel_id := CartwheelId, spoke_id := SpokeId, spoke_name := SpokeName,
...
%% Accessors
get_cartwheel_id(#spoke_inventoried_v1{cartwheel_id = V}) -> V.
