...
new(#{cartwheel_id := CartwheelId, spoke_name := SpokeName,
...
validate(#inventory_spoke_v1{cartwheel_id = P}) when
...
to_map(#inventory_spoke_v1{} = Cmd) ->
    #{
        ...
        cartwheel_id => Cmd#inventory_spoke_v1.cartwheel_id,
...
%% Accessors
get_cartwheel_id(#inventory_spoke_v1{cartwheel_id = V}) -> V.
