%%% @doc API handler: POST /api/cartwheels/:cartwheel_id/architecture/complete
%%%
%%% Completes the architecture phase for a cartwheel.
%%% @end
-module(complete_architecture_api).
...
handle_post(Req0, _State) ->
    ...
    dispatch(complete_architecture_v1, maybe_complete_architecture, CmdParams, Req0).
