...
validate(#complete_architecture_v1{cartwheel_id = P}) when
...
to_map(#complete_architecture_v1{} = Cmd) ->
    #{
        ...
        cartwheel_id => Cmd#complete_architecture_v1.cartwheel_id
    }.
...
%% Accessors
get_cartwheel_id(#complete_architecture_v1{cartwheel_id = V}) -> V.
