...
-export([get_cartwheel_id/1, get_from_phase/1, get_to_phase/1]).
...
validate(#transition_phase_v1{cartwheel_id = P}) when
...
to_map(#transition_phase_v1{} = Cmd) ->
    #{
        ...
        cartwheel_id => Cmd#transition_phase_v1.cartwheel_id,
...
%% Accessors
get_cartwheel_id(#transition_phase_v1{cartwheel_id = V}) -> V.
