%%% @doc API handler: POST /api/cartwheels/:cartwheel_id/discovery/start
%%%
%%% Starts the discovery phase for a cartwheel.
%%% @end
...
handle_post(Req0, _State) ->
    ...
    dispatch(start_discovery_v1, maybe_start_discovery, CmdParams, Req0).
