...
-export([get_cartwheel_id/1, get_term_id/1, get_term/1, get_definition/1]).
...
new(#{cartwheel_id := CartwheelId, term := Term, definition := Definition} = Params) ->
    Cmd = #define_term_v1{
...
to_map(#define_term_v1{} = Cmd) ->
    #{
        ...
        cartwheel_id => Cmd#define_term_v1.cartwheel_id,
...
%% Accessors
get_cartwheel_id(#define_term_v1{cartwheel_id = V}) -> V.
