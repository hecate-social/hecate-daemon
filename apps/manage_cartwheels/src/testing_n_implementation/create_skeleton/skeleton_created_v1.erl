...
-export([get_cartwheel_id/1, get_skeleton_id/1, get_description/1, get_created_at/1]).
...
new(#{cartwheel_id := CartwheelId, skeleton_id := SkeletonId} = Params) ->
    #skeleton_created_v1{
...
to_map(#skeleton_created_v1{} = E) ->
    #{
        ...
        cartwheel_id => E#skeleton_created_v1.cartwheel_id,
...
from_map(#{cartwheel_id := CartwheelId, skeleton_id := SkeletonId} = Map) ->
...
%% Accessors
get_cartwheel_id(#skeleton_created_v1{cartwheel_id = V}) -> V.
