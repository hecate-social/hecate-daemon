...
new(#{cartwheel_id := CartwheelId, implementation_id := ImplementationId,
...
to_map(#spoke_implemented_v1{} = E) ->
    #{
        ...
        cartwheel_id => E#spoke_implemented_v1.cartwheel_id,
...
from_map(#{cartwheel_id := CartwheelId, implementation_id := ImplementationId,
...
%% Accessors
get_cartwheel_id(#spoke_implemented_v1{cartwheel_id = V}) -> V.
