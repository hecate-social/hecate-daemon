...
-export([get_cartwheel_id/1, get_incident_id/1, get_severity/1, get_description/1, get_reported_at/1]).
...
to_map(#incident_reported_v1{} = E) ->
    #{
        ...
        cartwheel_id => E#incident_reported_v1.cartwheel_id,
...
%% Accessors
get_cartwheel_id(#incident_reported_v1{cartwheel_id = V}) -> V.
