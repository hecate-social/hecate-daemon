...
-export([get_cartwheel_id/1, get_incident_id/1, get_severity/1, get_description/1]).
...
validate(#report_incident_v1{cartwheel_id = P}) when
...
to_map(#report_incident_v1{} = Cmd) ->
    #{
        ...
        cartwheel_id => Cmd#report_incident_v1.cartwheel_id,
...
%% Accessors
get_cartwheel_id(#report_incident_v1{cartwheel_id = V}) -> V.
