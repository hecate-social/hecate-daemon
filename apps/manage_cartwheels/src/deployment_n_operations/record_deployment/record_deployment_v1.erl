...
-export([get_cartwheel_id/1, get_deployment_id/1, get_environment/1, get_version/1, get_notes/1]).
...
validate(#record_deployment_v1{cartwheel_id = P}) when
...
to_map(#record_deployment_v1{} = Cmd) ->
    #{
        ...
        cartwheel_id => Cmd#record_deployment_v1.cartwheel_id,
...
%% Accessors
get_cartwheel_id(#record_deployment_v1{cartwheel_id = V}) -> V.
