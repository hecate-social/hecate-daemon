...
-export([get_cartwheel_id/1, get_deployment_id/1, get_environment/1, get_version/1, get_notes/1, get_deployed_at/1]).
...
new(#{cartwheel_id := CartwheelId, deployment_id := DeploymentId,
...
to_map(#deployment_recorded_v1{} = E) ->
    #{
        ...
        cartwheel_id => E#deployment_recorded_v1.cartwheel_id,
...
from_map(#{cartwheel_id := CartwheelId, deployment_id := DeploymentId,
...
%% Accessors
get_cartwheel_id(#deployment_recorded_v1{cartwheel_id = V}) -> V.
