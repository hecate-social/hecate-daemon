%%% @doc TUI emitter: venture_initiated_v1 -> TUI SSE connections
%%%
%%% Listens to the venture_initiated_v1 pg group and broadcasts
...
-define(SCOPE, pg).
-define(EVENT_GROUP, venture_initiated_v1).
...
init([]) ->
    ...
    logger:info("[venture_initiated_v1_to_tui] Emitter started, joined ~p group", [?EVENT_GROUP]),
    {ok, #{}}.
