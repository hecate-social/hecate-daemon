...
to_map(#design_resumed_v1{division_id = V, resumed_at = RA}) ->
    #{
...
from_map(Map) ->
    ...
    {ok, #design_resumed_v1{division_id = DivisionId, resumed_at = ResumedAt}}.

get_division_id(#design_resumed_v1{division_id = V}) -> V.
get_resumed_at(#design_resumed_v1{resumed_at = V}) -> V.
