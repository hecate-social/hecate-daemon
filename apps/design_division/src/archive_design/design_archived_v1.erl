...
to_map(#design_archived_v1{division_id = V, archived_at = AA, archived_by = AB, reason = R}) ->
    #{
...
get_division_id(#design_archived_v1{division_id = V}) -> V.
get_archived_at(#design_archived_v1{archived_at = V}) -> V.
get_archived_by(#design_archived_v1{archived_by = V}) -> V.
get_reason(#design_archived_v1{reason = V}) -> V.
