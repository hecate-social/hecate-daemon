...
to_map(#design_started_v1{division_id = V, started_at = SA, started_by = SB}) ->
    #{
...
from_map(Map) ->
    ...
    {ok, #design_started_v1{division_id = DivisionId, started_at = StartedAt, started_by = StartedBy}}.

get_division_id(#design_started_v1{division_id = V}) -> V.
get_started_at(#design_started_v1{started_at = V}) -> V.
get_started_by(#design_started_v1{started_by = V}) -> V.
